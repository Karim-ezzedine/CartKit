...
/// Core Data stack wrapper used by `CartKitStorageCoreData`.
///
...
public actor CoreDataCartStore {
    ...
    public init(configuration: CoreDataCartStoreConfiguration = .init()) async throws {
        ...
        container.viewContext.name = "CartKitStorageCoreData.viewContext"
        
        let bg = container.newBackgroundContext()
        bg.mergePolicy = policy
        bg.name = "CartKitStorageCoreData.backgroundContext"
